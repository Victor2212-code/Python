...
# cpf_enviado_usuario = '364.408.470-07'.replace('.', '').replace('-', '')
entrada = input('CPF [764.824.890-70]: ')
...
numero_cpf = cpf_enviado_usuario[:9]
...
dez_digitos = numero_cpf + str(digito)
...
cpf_gerado_pelo_calculo = f'{numero_cpf}{digito_1}{digito_2}'
